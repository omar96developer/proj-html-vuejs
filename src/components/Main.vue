        ...
        <div  class="container-lg courses_a p-5">
          ...
          <div class="row d-flex  courses_a">
            ...
            <div class="col-4  courses_ab">
              <div class="courses_a1 text-center position-relative p-5 courses_ac">
                ...
                <a href="#" class="btn  link_1">COURSE INFORMATION</a>
                <img src="../assets/img/new-corner.jpg" alt="corner" class="position-absolute top-0 start-0" style="height:80px;">
              </div>
            </div>
              <!-- course learn more -->
            <div class="col-8 courses_a2  d-flex  justify-content-around ">

              <div class=" p-5" >
                <img src="../assets/img/courses-passplus.jpg" class="card-img-top" alt="passplus">
                <div class="card-body text-center">
                  <h6 class="card-title">Pass Plus</h6>                    
                ...
                <div class="card-body text-center">
                  <h6 class="card-title">Intensive Course</h6>                    
                  <a href="#" class="btn ">LEARN MORE</a>
                </div>
              </div>
                <div class="p-5" >
